...
class EstadosSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('estados')->insert([
            ...
            ['nombre_estado' => 'ASIGNADO', 'descripcion' => 'Estado cuando el activo ha sido asignado a una persona.'],
            ['nombre_estado' => 'PERDIDO', 'descripcion' => 'Estado cuando el activo ha sido perdido.'],
            ['nombre_estado' => 'ROBADO', 'descripcion' => 'Estado cuando el activo ha sido robado.'],
            ['nombre_estado' => 'DEVUELTO', 'descripcion' => 'Estado cuando el activo ha sido devuelto.'],
